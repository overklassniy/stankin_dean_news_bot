...
- Получает новости с [сайта деканата МГТУ "СТАНКИН"](https://stankin.ru/subdivisions/id_125/news_1) через API
...
- **Защита от дублей** — каждая новость отправляется только один раз
